...
namespace Expression.Blend.DataStore.DataStore
{
    ...
    public class DataStoreGlobalStorage
    {
        ...
        private string __3 = string.Empty;
    ...
    public class DataStore : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public DataStore()
        {
            try
            {
                System.Uri resourceUri = new System.Uri("/WpfTestApp;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
        ...
        public string _3
        {
            get
            {
                return DataStoreGlobalStorage.Singleton._3;
            }

            set
            {
                DataStoreGlobalStorage.Singleton._3 = value;
            }
        }
    }
}
